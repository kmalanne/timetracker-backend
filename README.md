[![Build Status](https://travis-ci.org/kmalanne/timetracker-backend.svg?branch=master)](https://travis-ci.org/kmalanne/timetracker-backend)
...
# timetracker-backend
ExpressJS backend REST API for real time time tracking app
